...
class SlotTest {
        ...
        void testNewSlotWhenColumnIsLessThanZero(final int column) {
                ...
                final Exception e = assertThrows(IllegalArgumentException.class, () -> new Slot(column, 0));
        ...
        void testSlotOfWhenColumnIsLessThanZero(final int column) {
                ...
                final Exception e = assertThrows(IllegalArgumentException.class, () -> Slot.of(column, 0));
